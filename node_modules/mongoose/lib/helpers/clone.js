...
function clone(obj, options = {}, isArrayChild) {
  ...
  if (isMongooseObject(obj)) {
    ...
    if (options.minimize && !obj.constructor.$__required && isSingleNested && Object.keys(ret).length === 0) {
      return undefined;
    }
...
function cloneObject(obj, options = {}, isArrayChild) {
  ...
  const seen = options._seen || new Map();
  const ret = {};
  let hasKeys;
  ...
  return minimize && !isArrayChild ? (hasKeys ? ret : undefined) : ret;
}
